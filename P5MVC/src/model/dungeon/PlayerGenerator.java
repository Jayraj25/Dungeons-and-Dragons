...
/**
 * Make the player for the dungeon game such that a player can move and pick up a treasure and can
 * kill monster with arrows. Player starts with 3 arrows by default.
 */
class PlayerGenerator implements Player {
  ...
  public int detectSmell() {
    locationList.forEach((l) -> l.setVisited(false));
