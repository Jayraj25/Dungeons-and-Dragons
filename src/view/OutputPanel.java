...
class OutputPanel extends JPanel {
  ...
  public OutputPanel() {
    ...
    setPreferredSize(new Dimension(0, 10000));
    setVisible(true);
  ...
  public void displayCurrentLocInfo(Map<Integer, Map<List<Directions>,
          List<TreasuresTypes>>> currentLocation,int arrowAtCurrentLoc,
          int smell, boolean status) {
    JLabel move;
    ...
    for (Map.Entry<Integer, Map<List<Directions>, List<TreasuresTypes>>>
            m1 : currentLocation.entrySet()) {
    ...
    ImageIcon movement = new ImageIcon(new ImageIcon("src/view/dungeon-images/movement.png")
  ...
  private void detectSmell(int smell) {
    if (smell != 0) {
      JLabel smellLabel;
      if (smell == 1) {
        smellLabel = new JLabel("Very pungent smell nearby!");
        smellLabel.setAlignmentX(CENTER_ALIGNMENT);
        add(smellLabel);
      }
      else if (smell == 2) {
        smellLabel = new JLabel("Pungent smell!");
        smellLabel.setAlignmentX(CENTER_ALIGNMENT);
        add(smellLabel);
      }
    }
  ...
  private void displayTreasure(List<TreasuresTypes> treasureList) {
    ...
    if (countDiamond != 0) {
      ImageIcon diamond = new ImageIcon(
              ...
              .getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
      JLabel diamondLabel = new JLabel(String.valueOf(countDiamond), diamond, SwingConstants.CENTER);
      diamondLabel.setAlignmentX(CENTER_ALIGNMENT);
      add(diamondLabel);
    }
    if (countRuby != 0) {
      ImageIcon ruby = new ImageIcon(new ImageIcon("src/view/dungeon-images/ruby.png")
              .getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
    ...
    if (countSapphire != 0) {
      ImageIcon sapphire = new ImageIcon(
              ...
              .getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
      JLabel sapphireLabel = new JLabel(String.valueOf(countSapphire), sapphire, SwingConstants.CENTER);
      sapphireLabel.setAlignmentX(CENTER_ALIGNMENT);
      add(sapphireLabel);
    }
    if (countTopaz != 0) {
      ImageIcon topaz = new ImageIcon(new ImageIcon("src/view/dungeon-images/emerald.png")
              .getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH));
